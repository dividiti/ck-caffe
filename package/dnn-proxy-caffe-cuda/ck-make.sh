...
export CK_INC_BLAS="${CK_FLAG_PREFIX_INCLUDE}${CK_ENV_LIB_CUBLAS_INCLUDE} ${CK_FLAG_PREFIX_INCLUDE}${CK_ENV_LIB_OPENBLAS_INCLUDE}"
export CK_INC_CAFFE="${CK_FLAG_PREFIX_INCLUDE}${CK_ENV_LIB_CAFFE_INCLUDE} ${CK_FLAG_PREFIX_INCLUDE}${CK_ENV_LIB_CAFFE_EXTRA_INCLUDE}"
...
export CK_LIB_BLAS="${CK_FLAG_PREFIX_LIB_DIR}${CK_ENV_LIB_CUBLAS_LIB} -lcublas ${CK_FLAG_PREFIX_LIB_DIR}${CK_ENV_LIB_OPENBLAS_LIB} -lopenblas"

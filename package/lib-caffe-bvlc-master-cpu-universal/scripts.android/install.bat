...
rem      -DCMAKE_HOST_SYSTEM_NAME="Windows" ^
rem      -DCMAKE_SYSROOT="%CK_SYS_ROOT%" ^
rem      -DCMAKE_ANDROID_API=%CK_ANDROID_API_LEVEL% ^
rem      -DCMAKE_ANDROID_ARCH_ABI=%CK_ANDROID_ABI% ^
...
rem      -DCMAKE_INSTALL_PREFIX="%INSTALL_DIR%/install" ^

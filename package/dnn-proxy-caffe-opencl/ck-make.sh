...
export CK_INC_OPENCL="${CK_FLAG_PREFIX_INCLUDE}${CK_ENV_LIB_OPENCL_INCLUDE}"
export CK_INC_VIENNACL="${CK_FLAG_PREFIX_INCLUDE}${CK_ENV_LIB_VIENNACL_INCLUDE}"
export CK_INC_LOCAL="${CK_FLAG_PREFIX_INCLUDE} ."
export CK_INCS_1="${CK_INC_BOOST} ${CK_INC_BLAS} ${CK_INC_CAFFE} ${CK_INC_GFLAGS} ${CK_INC_GLOG}"
export CK_INCS_2="${CK_INC_OPENCV} ${CK_INC_PROTOBUF} ${CK_INC_OPENCL} ${CK_INC_VIENNACL} ${CK_INC_LOCAL}"
export CK_COMPILER_FLAGS_MISC="${CK_INCS_1} ${CK_INCS_2} ${CK_COMPILER_FLAGS_MISC}"
...
export CK_LIB_OPENCL="${CK_FLAG_PREFIX_LIB_DIR}${CK_ENV_LIB_OPENCL_LIB} -lOpenCL"
export CK_LIBS_1="${CK_LIB_BOOST} ${CK_LIB_BLAS} ${CK_LIB_CAFFE} ${CK_LIB_GFLAGS} ${CK_LIB_GLOG}"
export CK_LIBS_2="${CK_LIB_OPENCV} ${CK_LIB_PROTOBUF} ${CK_LIB_OPENCL}"
export CK_LD_FLAGS_MISC="${CK_LIBS_1} ${CK_LIBS_2} ${CK_LD_FLAGS_MISC}"
